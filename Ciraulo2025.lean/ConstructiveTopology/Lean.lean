-- This module serves as the root of the `ConstructiveTopology.Lean` library.
-- Import modules here that should be built as part of the library.
import ConstructiveTopology.Lean.Basic
...
variable {α : Type} [PartialOrder α] -- α is a powered set of a topological space
